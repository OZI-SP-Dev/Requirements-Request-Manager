                ...
                <Card className="m-auto p-0" as={Col} lg='9' sm='10' xs='12'>
                    ...
                    <Card.Text>
                        <ul>
                            ...
                            <li>Requirement is presented to the IRM Group, chaired by AFLCMC/XP-OZ and consists of 2Ltr & Executive Center Deputies, Directorates, 66th and 88th ABWs, and SMEs as required – <i>every 4 weeks</i></li>
